...
| Comparison | Failed attempt retained: 177 PASS / 8 FAIL, 237 prior checks unreached, one reviewed How-To image. Follow-up compiled reader gate passes 124/124, retaining 116 prior checks and resolving both preservation failures by accounting for exact policy-save observations; delayed unassisted closure and unchanged packages. | Resolve the five diagnostic foreground-capture failures and 0x800AC472 form-state read before repeating the broad gate. The focused reader correction supplies no new visible comparison acceptance. Earlier candidate's 421/421 and 31 images remain historical evidence. |
