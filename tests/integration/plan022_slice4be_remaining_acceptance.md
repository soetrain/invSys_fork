...
| Comparison | Current attempt: 177 PASS / 8 FAIL, 237 prior checks unreached, one reviewed How-To image; delayed unassisted closure. Actual PolicyChangeClosesIncomplete passes. | Diagnose two byte-preservation failures, five diagnostic foreground-capture failures and the 0x800AC472 form-state read. Preserve the failed attempt; require a focused cause/fix before another broad run. Earlier candidate's 421/421 and 31 images remain historical evidence. |
