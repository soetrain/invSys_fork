...
|---|---|---|
| Production draft observations | Initial designer candidate passes 228/228 after 63 PASS/165 expected FAIL; six real handlers, saved-authority/unknown-column preservation, denial, disabled collection and stale binding guards. `validation-production-designer-captions` passes 234/234 after three expected metadata failures; all earlier identities retained, five compiles and unchanged dynamic/duplicate metrics. Its reusable gate retains all 67 Boolean observations. | Finish positive Recipe validation, recording/publication/diagnostic integration and native designer evidence in [designer evidence](plan022_slice4be_production_designer_results.md). This is partial coverage, not complete six-control or Slice 4be acceptance. |
...
| Full chain/live roles/Create Warehouse | Corrected Production-caption candidate: 32/48/15 passes with exact prior identities, normal unassisted closure, zero Application failures, settings/three reports restored and five package/269 tooling hashes preserved. Earlier palette/boundary/layout/frozen gates retain their scope. | Preserve; repeat only after a relevant change or new concern. Earlier crashes remain unexplained. See [current designer evidence](plan022_slice4be_production_designer_results.md), [palette evidence](plan022_production_palette_results.md), [boundary candidate](plan022_production_quiet_boundary_results.md) and [earlier projection/header evidence](plan022_slice4be_shutdown_header_results.md). Other workstreams and human acceptance remain open. |
